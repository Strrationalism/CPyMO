...
cpymo_input cpymo_input_snapshot()
{
	...
	MAP_CONTROLLER(ok, SDL_CONTROLLER_BUTTON_RIGHTSHOULDER);
	MAP_CONTROLLER(ok, SDL_CONTROLLER_BUTTON_RIGHTSTICK);
#else
	...
	MAP_CONTROLLER(ok, SDL_CONTROLLER_BUTTON_B);
	MAP_CONTROLLER(hide_window, SDL_CONTROLLER_BUTTON_X);
	MAP_CONTROLLER(cancel, SDL_CONTROLLER_BUTTON_A);
	MAP_CONTROLLER(skip, SDL_CONTROLLER_BUTTON_Y);
#else
